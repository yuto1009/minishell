...
built_in/builtin_unset.c built_in/builtin_echo.c built_in/builtin_pwd.c built_in/builtin_cd.c built_in/builtin_cd_utils.c built_in/error_builtin.c src/map_get.c src/map_init.c\
...
src/expand_append_utils.c src/expand_append.c src/expand_is.c src/expand_remove.c src/error_exit.c src/signal_init.c 
OBJS = $(SRCS:.c=.o)
