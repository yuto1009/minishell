...
# RLDIR    = $(shell brew --prefix readline)-fsanitize=address
...
src/tokenize_error.c src/search_path.c src/exec_cmd.c src/exec.c src/wait_pid.c src/expand.c src/map.c built_in/builtin_export.c \
