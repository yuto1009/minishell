...
src/tokenize_error.c src/search_path.c src/exec_cmd.c src/exec.c src/wait_pid.c src/expand.c src/map.c built_in/builtin_export.c built_in/builtin_export_utils.c \
built_in/builtin_unset.c built_in/builtin_echo.c built_in/builtin_pwd.c built_in/builtin_cd.c built_in/builtin_cd_utils.c built_in/error_builtin.c \
 src/map_get.c src/map_init.c src/trim_env.c\
